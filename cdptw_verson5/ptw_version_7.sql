...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 29, 2019 lúc 01:57 AM
...
--
-- Cấu trúc bảng cho bảng `distances`
--
...
--
-- Đang đổ dữ liệu cho bảng `distances`
--
...
--
-- Đang đổ dữ liệu cho bảng `flightdetails`
--
...
(3, 1, 'AVC', 21, 22, '2019-07-24 01:01:00', '2019-07-30 07:01:00', 3000000, NULL, NULL),
(4, 2, 'ABC', 21, 22, '2019-05-30 08:00:00', '2019-07-30 08:00:00', 15000000, NULL, NULL),
(5, 1, '1023', 21, 22, '2019-10-31 11:11:00', '2019-11-06 17:11:00', 3000000, NULL, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `flightseat`
--
...
--
-- Cấu trúc bảng cho bảng `rela_countries`
--
...
--
-- Đang đổ dữ liệu cho bảng `rela_countries`
--
...
(1, 'Freeman Murphy', 'lkilback@example.org', '$2y$10$hNmrYVndr3/KIHmIsaBgnuu8J4WlnvhPHWBTuL4LIjQFpM7OJjF3i', 'aUw9HWP5Bi', 'Z4XvN9eVAA', 0, NULL, '2019-03-26 00:29:20', '2019-03-13 07:04:57', '2019-03-26 00:28:20'),
...
(4, 'Prof. Leann Hoeger', 'ftoy@example.net', '$2y$10$hNmrYVndr3/KIHmIsaBgnuu8J4WlnvhPHWBTuL4LIjQFpM7OJjF3i', 'baZkqbbzSL', 'AZkguaTkFtAfbjwnddt13hqvXnxDJrlMrwTm2T4StbHRGhS1jfylJnrAYPOt', 0, '2019-03-26 00:25:08', NULL, '2019-03-13 07:04:58', '2019-03-26 00:25:08'),
...
(6, 'chelsea99@example.net', 'chelsea99@example.net', '$2y$10$HG.xeVl2UImBvTI4iiYzgO5lv6VmFJV38Eaf3PXxPRZmnnJxE/Gsi', '0123456789', NULL, 0, NULL, NULL, '2019-03-25 13:59:07', '2019-03-25 13:59:07'),
(7, 'Lê Nguyễn Tấn Tài v2', 'admintai@admin.com', '$2y$10$qZLbr1QsKbN/QzZvG3Zt1elNYIpBksh.TXhLzmLMLlTTEggVVkV3e', '0123456789', 'o1lZQXji3rNkrB3YklDzAciSwS5hiklTKhLdrkufe0GTZOYsClDP9adyPSTr', 0, '2019-03-25 14:27:19', NULL, '2019-03-25 14:27:06', '2019-03-25 14:27:19'),
(8, 'Lê Nguyễn Tấn Tàia', 'chelse8@example.net', '$2y$10$qXv0I2bqy/4rCohXbz7Oi.MmYpi9ckJde.mEjY0HCBHOBhjbaITl.', '1111111111', 'W6TxOF3ofYg86YRSqWrW2ZBItXQAf0D3NGiiFVgxZbnZzK4uDg5o0tzImr38', 0, '2019-03-26 01:14:23', NULL, '2019-03-26 00:44:58', '2019-03-26 01:14:23'),
(9, 'Lê Nguyễn Tấn Tài', 'ch88@example.net', '$2y$10$xK/MRlx6z6TAYaleScxlz.XLQyXwYBGu46q2GZONFT6Nrwg6qOU8e', '0123456789', '8YUXkFaDGJIj54Pj4Km8mYeSp4a0JEGoL7CFwlXayIcdB9v3wZu479gO5MVp', 0, '2019-03-28 06:30:50', NULL, '2019-03-28 06:21:37', '2019-03-28 06:30:50'),
(10, 'Lê Nguyễn Tấn Tài v3', 'chel8@example.net', '$2y$10$BjSPMiYCXeE4daLC8C9OsuKjmkP4.EGTIeHHe82wEAQWYE7hbzciq', '0123456789', 'x2RVR4mzcnu0ymoBduPqlK4jJm8fPM4juRjDXfNFjecMdjbulBkcn0lxEpvW', 0, '2019-03-28 06:38:41', NULL, '2019-03-28 06:31:16', '2019-03-28 06:38:41');
...
--
-- Chỉ mục cho bảng `rela_countries`
--
...
--
-- AUTO_INCREMENT cho bảng `distances`
--
ALTER TABLE `distances`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `flightdetails`
--
ALTER TABLE `flightdetails`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `flightseat`
--
ALTER TABLE `flightseat`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `rela_countries`
--
ALTER TABLE `rela_countries`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- Các ràng buộc cho bảng `airline`
--
ALTER TABLE `airline`
...
--
-- Các ràng buộc cho bảng `distances`
--
ALTER TABLE `distances`
...
--
-- Các ràng buộc cho bảng `flightdetails`
--
ALTER TABLE `flightdetails`
...
--
-- Các ràng buộc cho bảng `flightseat`
--
ALTER TABLE `flightseat`
...
--
-- Các ràng buộc cho bảng `rela_countries`
--
ALTER TABLE `rela_countries`
