...
@section('content')
    ...
    <div class="container">
        ...
        <div class="frameinserch" style="background-image: linear-gradient(to right, #92fee9 0%, #00d7ea 100%); position:  absolute; top: 50%; left: 50%; transform: translate(-50%,-50%); padding: 10px; width: 50%; height: auto; box-shadow: 0 5px 10px rgba(0,0,0,0.5);">
